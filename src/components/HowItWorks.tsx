      ...
      <div className="container">
        <div>
          ...
          <div className="flex gap-y-5 flex-col md:flex-row md:gap-x-[30px]">
            ...
            <div className="p-5 xl:p-[30px] md:pb-[30px] md:pt-[10px] xl:pt-[10px] rounded-[20px] gap-5 w-full h-full bg-secondary flex group hover:shadow-md md:flex-col items-center md:min-h-[388px] xl:min-h-[432px]">
              <div className="min-w-[100px] min-h-[100px] max-w-[250px] bg-[url(/img/wallet.png)] bg-center bg-cover">
                <div className="w-full h-full group-hover:bg-[url(/img/walletBG.png)] bg-center bg-cover">
                  <img
                    className="scale-[0.8] group-hover:scale-[1.2]"
