    ...
    <section className="py-10 md:py-20">
      <div className="container">
        ...
        >
          ...
          <div
            className="flex flex-col justify-end w-full h-full md:row-start-1 md:row-end-3 rounded-[20px] hover:shadow-md
            min-h-[330px] max-w-[330px] md:max-w-[330px] md:max-h-[330px] xl:max-w-[510px] xl:max-h-[510px] group cursor-pointer"
          >
            <div className="w-full overflow-hidden rounded-t-[20px]">
              <img className="object-cover h-full w-full group-hover:scale-105" src="img/hero1.png" alt="hero" />
            </div>
